            ...
            <div className="space-y-0">
              {menuItems.map((item, index) => (
                <motion.button
                  ...
                  className="block font-light text-gray-600 hover:text-gray-900 transition-colors duration-300 text-left"
              ...
              <div className="space-y-2">
                {socialItems.map((item, index) => (
                  <motion.a
                    ...
                    className="block font-light text-gray-600 hover:text-gray-900 transition-colors duration-300"
                    initial={{ opacity: 0, x: -20 }}
                    whileInView={{ opacity: 1, x: 0 }}
