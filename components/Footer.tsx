...
const Footer = () => {
 ...
 return (
 <footer className="bg-[#0a0a0a] text-[#f0f0ea] relative z-content">
 <div className="max-w-7xl px-4 border-0 mx-auto my-0 py-12 pb-8">
 <div className="flex justify-between">
 {/* Menu */}
 <div className="w-1/2">
 <motion.h3
 className="text-lg font-bold mb-4 text-[#f0f0ea] border-b-2 border-gray-300 pb-2"
 ...
 className="block font-light text-gray-600 hover:text-[#f0f0ea] transition-colors duration-300 text-left"
 ...
 className="block font-light text-gray-600 hover:text-[#f0f0ea] transition-colors duration-300"
 initial={{ opacity: 0, x: -20 }}
 whileInView={{ opacity: 1, x: 0 }}
 ...
 >
 <div className="font-black mb-2 text-[#f0f0ea] text-6xl leading-6 tracking-tighter">© 2025 Soban Ahmad</div>
